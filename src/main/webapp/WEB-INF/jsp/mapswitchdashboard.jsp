...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<div class="row">
			...
			<div class="col-md-4" >
				<form action="" method="">
					<div class="box" style="width: 700px; height: auto; margin-left:150px; background-color: white;  font-weight: bold; ">
...
<div
			...
			<i class="fa fa-check" style="color: white;"></i>
				<button type="button" class="close" data-dismiss="modal" style="margin-top:-25px; margin-right: 20px;">&times;</button> 
...
<script>
	$(document).ready(function() {
		...
		$("#refersh").click(function(){
			...
			location.reload();
/* 			$("#success_msg").empty();
			$("#success_msg").append("Refresh Completed!!");
