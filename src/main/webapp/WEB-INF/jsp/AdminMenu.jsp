...
<ul id="nav" class="dropdown dropdown-horizontal">
	...
	<c:forEach var="menu" items="${navigationBean.menu}">
		<c:choose>
			<c:when test="${menu.parent_id eq 1 && fn:trim(menu.page_url) eq '' && fn:trim(menu.page_level) eq 2 }">
				<li>
			...
			<c:when test="${menu.parent_id eq 1 && fn:trim(menu.page_url) != '' && fn:trim(menu.page_level) eq 2 }">
