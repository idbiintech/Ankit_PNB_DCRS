...
<form:form id="uploadform"  action="NTSLFileUpload.do" method="POST"  commandName="visaUploadBean" enctype="multipart/form-data" >
                   ...
                   <div class="box-body">
                     ...
                     <div class="form-group" style="display:${display}">
							...
							<form:select class="form-control" path="fileName" id="fileName">
								<option value="0">--Select --</option>
									...
									<!-- <option value="CC">CREDIT CARD EP</option>  -->
							</form:select>
						</div>
					<%-- <div class="form-group" style="display:${display}" >
							<label for="exampleInputEmail1" >File Type</label> 
					...
					<div class="form-group" style="display: none" path="ccSubCategory" id="ccSubCategory">
							<label for="exampleInputEmail1" >File Type</label> 
					...
					<div class="form-group" style="display: ${display}" path="epSubCategory" id="epSubCategory">
							<label for="exampleInputEmail1" >File Type</label> 
							<form:select class="form-control" path="fileType" id="fileType">
								<option value="0">--Select --</option>
									<option value="DOMESTIC">Domestic/International</option>
									<!-- <option value="INTERNATIONAL">International</option> -->
							</form:select>
						</div>	
