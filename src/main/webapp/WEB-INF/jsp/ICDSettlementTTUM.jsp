	...
	function DownloadAdjTTUM() {
		debugger;
			...
			$.ajax({
				...
				data:{datepicker:datepicker,adjCategory:adjCategory,category:category},
					...
					<form:form id="reportform" action="DownloadAdjTTUMSETTL.do"
						...
						<div class="box-body" id="subcat">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Settlement Category</label> <select
									...
									<option value="REPORT_STTL_ICD">SETTLEMENT REPORT</option>
									<option value="TTUM_STTL_ICD">SETTLEMENT TTUM</option>
                     ...
                     -->
						...
						<div class="box-footer" style="text-align: center">
							...
							<button type="button" 
								onclick="DownloadAdjTTUM();">Download</button>
