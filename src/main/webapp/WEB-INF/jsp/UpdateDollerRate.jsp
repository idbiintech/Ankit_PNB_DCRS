...
function ReportRollback() {
	...
	if (Validation()) {
		$.ajax({
			type : 'POST',
			url : 'rollbackUpdateDollarRate.do',
			async : true,
			beforeSend : function() {
				showLoader();
			},
...
<form:form id="processform"  action="DownloadSettlementVisa.do" method="POST"  commandName="rupaySettlementBean" >
				<div class="box-body">
						  ...
						  <div class="form-group" >
							<label for="exampleInputEmail1">Dollar Rate</label> <input
									type="text" class="form-control" id="issacqtype" placeholder=""> 
						</div>
					...
					<button type="button" onclick="processSettlement();" >Update</button>
