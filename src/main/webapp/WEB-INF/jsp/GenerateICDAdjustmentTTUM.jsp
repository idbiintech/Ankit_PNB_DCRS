	...
	function DownloadAdjTTUM() {
		...
		if (ValidateData()) {
			$.ajax({
				...
				type : 'POST',
				url : 'ValidateDownloadAdjTTUMICD.do',
				async : true,
				beforeSend : function() {
					showLoader();
				},
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
					<form:form id="reportform" action="DownloadAdjTTUMICD.do"
...
s
   ...
   <div
			style="font-size: 14px; font-weight: bold; border-radius: 3px;color: white; text-align: center; background: yellowgreen; margin-top: -480px; margin-left: 1220px; width: 400px; padding: 15px 25px; display: none;"
