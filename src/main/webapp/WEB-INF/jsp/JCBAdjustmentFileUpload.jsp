...
<form:form id="uploadform"  action="AdjustmentFileUpload.do" method="POST"  commandName="nfsSettlementBean" enctype="multipart/form-data" >
                    ...
                    <div class="form-group" style="display:${display}">
							...
							<!-- 		<option value="NTSL-NFS">NFS</option>
										<option value="NTSL-DFS">DFS</option> -->
										<option value="NTSL-JCB">JCB</option>
							</form:select>
						</div>
					...
					<div class="box-footer" style="text-align: center">
						...
						<button type="button" onclick="processAdjFileUpload();" >UPLOAD</button>
...
<div
			style="font-size: 14px; font-weight: bold; border-radius: 3px;color: white; text-align: center; background: yellowgreen; margin-top: -380px; margin-left: 1270px; width: 350px; padding: 15px 25px; display: none;"
			...
			<div
			style="font-size: 14px; font-weight: bold; color: white;border-radius: 3px; text-align: center; background: red; margin-top: -380px; margin-left: 1270px; width: 350px; padding: 15px 25px; display: none;"
