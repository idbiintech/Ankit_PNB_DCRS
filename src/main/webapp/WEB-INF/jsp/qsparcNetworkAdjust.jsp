...
<div class="content-wrapper">
	...
	<section class="content-header">
			...
			QSPARC ADJUSTMENT FILE UPLOAD
			<!-- <small>Version 2.0</small> -->
		</h1>
<!-- 		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">QSPARC Adjustment File Upload</li>
		</ol> -->
	</section>
...
<form:form id="uploadform"  action="rupayAdjustmentFileUpload.do" method="POST"  enctype="multipart/form-data" >
					...
					<div class="box-body" id="subcat">
					 <div class="form-group" id="Date" style="display:${display}" >
							<label>File Date</label> <input
								class="form-control" name="fileDate" value="--Select --"readonly="readonly"
					...
					<div class="box-footer" style="text-align: center">
						<button type="button" onclick="processRupayAdjustUpload();" >UPLOAD</button>
