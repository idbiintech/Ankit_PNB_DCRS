...
function processSettlement(){
	...
	if(ValidateData())  {
		...
		$.ajax({
			type : "POST",
			url : "QsparcSettlementProcess.do",
			data :oMyForm ,
	...
	function DownloadSettlement() {
		...
		if(ValidateData())  {
			...
			$.ajax({
				type : "POST",
				url : "ValidateQsparcSettlement.do",
				data :oMyForm ,
	...
	function ReportRollback() {
		...
		if (Validation()) {
			$.ajax({
				type : 'POST',
				url : 'rollbackRUPAYSETTLQsparc.do',
				async : true,
				beforeSend : function() {
					showLoader();
				},
...
<div class="content-wrapper">
	...
	<section class="content-header">
			...
			QSPARC SETTELMENT PROCESS
			<!-- <small>Version 2.0</small> -->
		</h1>
<!-- 		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">Qsparc Settlement Process</li>
		</ol> -->
	</section>
			...
			<div class="col-md-4">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
            <form:form id="processform"  action="DownloadSettlementQsparc.do" method="POST"  commandName="rupaySettlementBean" >
				<div class="box-body">
