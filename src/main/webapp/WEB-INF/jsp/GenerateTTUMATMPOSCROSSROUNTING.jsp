...
<script type="text/javascript"
	src="js/GenerateTTUMATMPOSCROSSROUNTING.js"></script>
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<form:form id="processform"
						action="DownloadUnmatchedTTUMATMPOSCROSSROUNTING.do" method="POST"
						...
						<div class="form-group">
							<label for="exampleInputEmail1">TTUM Category</label> <select
								...
								<option value="ATM_REPORT">ATM REPORT</option>
								<option value="ATM_TTUM">ATM TTUM</option>
								<option value="POS_REPORT">POS REPORT</option>
								<option value="POS_TTUM">POS TTUM</option>
