				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<form:form id="processform"
						action="DownloadExtractSwitchRawdata.do" method="POST"
						commandName="unmatchedTTUMBean">

					

						<div class="form-group">
							<label for="exampleInputEmail1">Type</label> <select
								style="margin-left: 10px; width: 520px;" class="form-control"
								name="TTUMCategory" id="TTUMCategory">
								<option value="-">--Select --</option>
								<option value="PTLF">PTLF</option>
								<option value="SwitchTLF">TLF</option>
