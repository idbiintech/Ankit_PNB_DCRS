			...
			<div class="col-md-6">
				...
				<div class="box box-primary">
                  ...
                  <h3 class="box-title">Quick Example</h3>
					...
					<!-- form start -->
					<%-- <form role="form"> --%>
<form:form id="processform"  action="VisaDownloadRupaySettlementTTUM.do" method="POST"  commandName="rupaySettlementBean" >
<div class="box-body">
					...
					<button type="button" onclick="VisaprocessSettlement();" >Process eod</button>
					<button type="button" onclick="VisaDownloadSettlement();" >Download</button>
