...
<script type="text/javascript" src="js/jquery-ui.min.js"></script>
<script type="text/javascript" src="js/iccwReconDownload.js"></script>
...
<h1 style="color: purple; text-align: center; font-weight: bold;">ICCW DOWNLOAD</h1>
		<ol class="breadcrumb">
			<li><a href="#"> Home</a></li>
			<li class="active">ICCW Download</li>
		</ol>
	</section>
				...
				<div class="box box-prima">
					...
					<%-- 	<div class="form-group">
							<input type="hidden" name="CSRFToken" id="CSRFToken"
								...
								Process </label> <select class="form-control" value="filename"
					...
					<div class="box-footer" style="text-align: center">
						<tr>
						<td><button id="downloadiccwBtn">Download ICCW<span id="bbpsinetRecon"></span>
						</button></td>
						<!-- <td><button class="btn btn-primary" id="iccwSummary">Download Summary<span id="bbpsinetRecon"></span>
						</button></td><br><br>
						<td><button class="btn btn-primary" id="iccwReport">ICCW REPORT<span id="bbpsinetRecon"></span>
						</button></td> -->
						</tr>
					</div>
				</div>
