...
<script type="text/javascript" src="js/VisaAdjustment.js"></script>
...
<form:form id="uploadform"  action="NTSLFileUpload.do" method="POST"  commandName="visaUploadBean" enctype="multipart/form-data" >
                    ...
                    <div class="form-group" style="display:${display}">
							<label for="exampleInputEmail1" >Adjustment File</label> 
							...
							<select type="text" id ="fileName" name ="fileName" class="form-control">
                   ...
                   <div class="form-group" id="Month" style="display:none" >
                     ...
                     <div class="form-group" id="Date" style="display" >
