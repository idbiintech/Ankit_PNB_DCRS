...
<!-- <script type="text/javascript" src="js/GenerateNFSTTUM.js"></script> -->
<script type="text/javascript">
	...
	function Process() {
		...
		if (ValidateData()) {
			...
			$.ajax({
				type : "POST",
				url : "GenerateUnmatchedTTUMICD.do",
				data : oMyForm,
						...
						<div class="box-body" id="subcat">
							...
							<div class="form-group" id="issuerOpt" style="display: none">
								...
								<form:select class="form-control" path="typeOfTTUM"
									...
									<option value="DROP">UNRECON CBS</option>
									
									<option value="PROACTIVE">UNRECON ICD</option>
