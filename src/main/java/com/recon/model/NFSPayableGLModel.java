...
public class NFSPayableGLModel {
	...
	public String toString() {
		return "NFSPayableGLModel [CYCLE=" + CYCLE + ", FILEDATE="  + ", CREATEDBY=" + CREATEDBY
				+ ", NO_OF_TXNS=" + NO_OF_TXNS + ", DEBIT=" + DEBIT + ", CREDIT=" + CREDIT + ", DESCRIPTION="
				+ DESCRIPTION + ", transtype=" + transtype + ", resp_code=" + resp_code + ", cardno=" + cardno
				+ ", RRN=" + RRN + ", stanno=" + stanno + ", ACQ=" + ACQ + ", ISS=" + ISS + ", trasn_date=" + trasn_date
				+ ", trans_time=" + trans_time + ", atmid=" + atmid + ", settledate=" + settledate + ", requestamt="
				+ requestamt + ", receivedamt=" + receivedamt + ", STATUS=" + STATUS + ", dcrs_remarks=" + dcrs_remarks
				+ ", FPAN=" + FPAN + ", sr_no=" + sr_no + ", filedate=" + filedate + ", no_of_txns="
				+ ", ttum_naration=" + ttum_naration + ", account_no=" + ", ACCOUNT_NUMBER="
				...
				+ ", TRAN_DATE=" + TRAN_DATE + ", TRANSACTION_PARTICULAR=" + TRANSACTION_PARTICULAR + "]";
	}
