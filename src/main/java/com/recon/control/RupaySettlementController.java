...
public class RupaySettlementController {
  ...
  @ResponseBody
  public String RupayFileUploadPost(@ModelAttribute("rupaySettlementBean") RupayUploadBean rupayBean, HttpServletRequest request, @RequestParam("file") MultipartFile file, HttpSession httpSession, Model model, ModelAndView modelAndView, RedirectAttributes redirectAttributes) throws Exception {
  ...
  public String DownloadSettlement(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpServletResponse response, HttpSession httpSession, Model model) throws Exception {
    ...
    if (beanObj.getSubcategory().equalsIgnoreCase("RRB_DOMESTIC")) {
      ...
      if (beanObj.getTTUM_TYPE().contains("EXCEL")) {
        ...
        fileName = "RUPAYSETTLEMENT" + beanObj.getCycle() + "TTUM" + 
          beanObj.getFileDate().replaceAll("/", "") + beanObj.getCycle() + "_VAL.txt";
        String stPath = OUTPUT_FOLDER;
        logger.info("TEMP_DIR" + stPath);
        GenerateUCOTTUM obj = new GenerateUCOTTUM();
        ...
        logger.info("File is created");
        logger.info("File is created");
        zipName = "RUPAYSETTLEMENT" + beanObj.getCycle() + "TTUM" + 
          beanObj.getFileDate().replaceAll("/", "") + beanObj.getCycle() + "_VAL.txt";
        File file = new File(String.valueOf(stPath) + File.separator + zipName);
        logger.info("path of zip file " + stPath + File.separator + zipName);
        FileInputStream inputstream = new FileInputStream(file);
      ...
      if (beanObj.getTTUM_TYPE().contains("EXCEL")) {
        ...
        fileName = "RUPAYSETTLEMENTINTTTUM" + beanObj.getFileDate().replaceAll("/", "-") + 
        ...
        logger.info("File is created");
        logger.info("File is created");
        zipName = "RUPAYSETTLEMENTINTTTUM" + beanObj.getFileDate().replaceAll("/", "-") + 
          beanObj.getCycle() + "_VAL.txt";
        File file = new File(String.valueOf(stPath) + File.separator + zipName);
        logger.info("path of zip file " + stPath + File.separator + zipName);
        FileInputStream inputstream = new FileInputStream(file);
  ...
  @ResponseBody
  public String rollbackRUPAYSETTL(@RequestParam("fileDate") String fileDate, @RequestParam("subcategory") String subcategory, @RequestParam("cycle") String cycle) throws ParseException, Exception {
  ...
  public ModelAndView UpdateDollerRate(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
  ...
  public ModelAndView VisaSettlementProcess(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
    logger.info("***** RupayFileUpload.Get Start ****");
    RupayUploadBean rupaySettlementBean = new RupayUploadBean();
    logger.info("RupayFileUpload GET");
    String display = "";
  ...
  @ResponseBody
  public String VisaSettlementProcessPost(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession) throws Exception {
  ...
  @ResponseBody
  public String UpdateDollerRate(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession) throws Exception {
    logger.info("***** VisaSettlementProcess.VisaSettlementProcess post Start ****" + beanObj.getFileType());
    logger.info("RupaySettlementProcess POST");
    logger.info("File Type is " + beanObj.getFileType() + " Date selected " + beanObj.getFileDate());
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
  ...
  @ResponseBody
  public String VisaSettlementValidate(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession) throws Exception {
    logger.info("***** RupaySettlementController.ValidateRupaySettlement post Start ****");
    logger.info("ValidateRupaySettlement POST");
    logger.info("File Type is " + beanObj.getFileType() + " Date selected " + beanObj.getFileDate());
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
  ...
  @ResponseBody
  public String rollbackVisaSETTL(@RequestParam("fileDate") String fileDate, @RequestParam("subcategory") String subcategory, @RequestParam("TTUM_TYPE") String cycle, @RequestParam("issacqtype") String issacqtype) throws ParseException, Exception {
  ...
  @ResponseBody
  public String rollbackUpdateDollarRate(@RequestParam("fileDate") String fileDate, @RequestParam("issacqtype") String issacqtype) throws ParseException, Exception {
    RupayUploadBean beanObj = new RupayUploadBean();
    beanObj.setFileDate(fileDate);
    beanObj.setFileType(issacqtype);
    boolean checkFlag = false;
  ...
  @ResponseBody
  public String rollbackRUPAYSETTLQsparc(@RequestParam("fileDate") String fileDate, @RequestParam("subcategory") String subcategory, @RequestParam("cycle") String cycle) throws ParseException, Exception {
    NFSSettlementBean beanData = new NFSSettlementBean();
    beanData.setCycle(Integer.valueOf(cycle).intValue());
    beanData.setStSubCategory(subcategory);
    beanData.setDatepicker(fileDate);
  ...
  @ResponseBody
  public String rollbackRUPAYADJ(@RequestParam("fileDate") String fileDate, @RequestParam("subcategory") String subcategory, @RequestParam("ADJTYPE") String ADJTYPE) throws ParseException, Exception {
    NFSSettlementBean beanData = new NFSSettlementBean();
  ...
  public ModelAndView QsparcSettlementProcessGet(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
    logger.info("***** RupayFileUpload.Get Start ****");
    RupayUploadBean rupaySettlementBean = new RupayUploadBean();
    logger.info("RupayFileUpload GET");
    String display = "";
  ...
  @ResponseBody
  public String QsparcSettlementProcessPost(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession) throws Exception {
    logger.info("***** RupaySettlementController.RupaySettlementProcess post Start ****");
    logger.info("RupaySettlementProcess POST");
    logger.info("File Type is " + beanObj.getFileType() + " Date selected " + beanObj.getFileDate());
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
  ...
  @ResponseBody
  public String ValidateQsparcSettlement(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession) throws Exception {
    logger.info("***** RupaySettlementController.ValidateRupaySettlement post Start ****");
    logger.info("ValidateRupaySettlement POST");
    logger.info("File Type is " + beanObj.getFileType() + " Date selected " + beanObj.getFileDate());
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
  ...
  public String DownloadSettlementQsparc(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpServletResponse response, HttpSession httpSession, Model model) throws Exception {
    logger.info("***** RupaySettlementController.DownloadSettlement post Start ****");
    logger.info("DownloadSettlement POST");
    logger.info("File Type is " + beanObj.getFileType() + " Date selected " + beanObj.getFileDate());
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
    ...
    if (beanObj.getSubcategory().equalsIgnoreCase("DOMESTIC")) {
      if (beanObj.getTTUM_TYPE().contains("EXCEL")) {
        ...
        fileName = "RUPAYQSPARCSETTLEMENTTTUM" + beanObj.getFileDate().replaceAll("/", "") + 
          beanObj.getCycle() + "_VAL.txt";
        String stPath = OUTPUT_FOLDER;
        logger.info("TEMP_DIR" + stPath);
        GenerateUCOTTUM obj = new GenerateUCOTTUM();
        ...
        logger.info("File is created");
        logger.info("File is created");
        zipName = "RUPAYQSPARCSETTLEMENTTTUM" + beanObj.getFileDate().replaceAll("/", "") + 
          beanObj.getCycle() + "_VAL.txt";
        File file = new File(String.valueOf(stPath) + File.separator + zipName);
        logger.info("path of zip file " + stPath + File.separator + zipName);
        FileInputStream inputstream = new FileInputStream(file);
      ...
      fileName = "RUPAYQSPARCSETTLEMENTINTTTUM" + beanObj.getFileDate().replaceAll("/", "") + 
        beanObj.getCycle() + "_VAL.txt";
      String stPath = OUTPUT_FOLDER;
      logger.info("TEMP_DIR" + stPath);
      GenerateUCOTTUM obj = new GenerateUCOTTUM();
      ...
      logger.info("File is created");
      logger.info("File is created");
      zipName = "RUPAYQSPARCSETTLEMENTINTTTUM" + beanObj.getFileDate().replaceAll("/", "") + 
        beanObj.getCycle() + "_VAL.txt";
      File file = new File(String.valueOf(stPath) + File.separator + zipName);
      logger.info("path of zip file " + stPath + File.separator + zipName);
      FileInputStream inputstream = new FileInputStream(file);
  ...
  public ModelAndView FundingTtumGet(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
  ...
  @ResponseBody
  public void DownloadSettlementTTUM(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletResponse response, HttpServletRequest request, HttpSession httpSession, Model model) throws Exception {
    logger.info("***** RupaySettlementController.DownloadSettlement post Start ****");
    logger.info("DownloadSettlement POST");
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
  ...
  @ResponseBody
  public String SettlementRectify(@ModelAttribute("nfsSettlementBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession, RedirectAttributes redirectAttributes, Model model) throws Exception {
  ...
  @ResponseBody
  public String NCMCFileUploadPost(@ModelAttribute("rupaySettlementBean") RupayUploadBean rupayBean, HttpServletRequest request, @RequestParam("file") MultipartFile file, HttpSession httpSession, Model model, ModelAndView modelAndView, RedirectAttributes redirectAttributes) throws Exception {
    logger.info("***** RupayFileUpload.post Start ****");
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
    logger.info("Created by is " + Createdby);
    rupayBean.setCreatedBy(Createdby);
  ...
  public ModelAndView RupayQsparcTTUMGet(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
  ...
  public ModelAndView presentmentFileUploadGet(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
    logger.info("***** RupayFileUpload.Get Start ****");
    RupayUploadBean rupaySettlementBean = new RupayUploadBean();
    logger.info("RupayFileUpload GET");
    String display = "";
  ...
  @ResponseBody
  public String PresentmentFileUploadPost(@ModelAttribute("rupaySettlementBean") RupayUploadBean rupayBean, HttpServletRequest request, @RequestParam("file") MultipartFile file, HttpSession httpSession, Model model, ModelAndView modelAndView, RedirectAttributes redirectAttributes) throws Exception {
    logger.info("***** RupayFileUpload.post Start ****");
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
    logger.info("Created by is " + Createdby);
    rupayBean.setCreatedBy(Createdby);
  ...
  @ResponseBody
  public String RupayQspracPost(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletRequest request, HttpSession httpSession) throws Exception {
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
    beanObj.setCreatedBy(Createdby);
    boolean executionFlag = false;
    logger.info("Subcategory is " + beanObj.getSubcategory());
  ...
  @ResponseBody
  public void VisaDownloadSettlementTTUM(@ModelAttribute("mastercardUploadBean") RupayUploadBean beanObj, HttpServletResponse response, HttpServletRequest request, HttpSession httpSession, Model model) throws Exception {
    logger.info("***** RupaySettlementController.DownloadSettlement post Start ****");
    logger.info("DownloadSettlement POST");
    String Createdby = ((LoginBean)httpSession.getAttribute("loginBean")).getUser_id();
    System.out.println("inside the download");
  ...
  public ModelAndView moneyadduploadget(ModelAndView modelAndView, @RequestParam("category") String category, HttpServletRequest request) throws Exception {
  ...
  @ResponseBody
  public String moneyadduploadpost(@ModelAttribute("rupaySettlementBean") RupayUploadBean rupayBean, HttpServletRequest request, @RequestParam("file") MultipartFile file, HttpSession httpSession, Model model, ModelAndView modelAndView, RedirectAttributes redirectAttributes) throws Exception {
