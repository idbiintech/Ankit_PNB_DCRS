...
//	public HashMap<String, Object> IccwuploadFile(CompareSetupBean setupBean,MultipartFile file) throws Exception ;



	boolean chkFileupload1(CompareSetupBean setupBean) throws Exception;

	boolean chkFileupload2(CompareSetupBean setupBean) throws Exception;
