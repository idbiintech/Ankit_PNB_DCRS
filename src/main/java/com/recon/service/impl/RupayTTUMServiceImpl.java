...
public class RupayTTUMServiceImpl extends JdbcDaoSupport implements RupayTTUMService {
  ...
  private class UnmatchedTTUMProc4 extends StoredProcedure {
		private static final String insert_proc = "NFS_C2C_ISS_RECON_TTUM";
    ...
    try {
      if (beanObj.getCategory().equalsIgnoreCase("RUPAY") && 
        ...
        if (beanObj.getStSubCategory().equals("ACQUIRER")) {
          ...
          String date = (String)getJdbcTemplate().queryForObject(maxQUERY, (Object[])new String[0], String.class);
      ...
      try {
        if (beanObj.getCategory().equalsIgnoreCase("NFS") && 
          ...
          icwCount = ((Integer)getJdbcTemplate().queryForObject(icwQuery, (Object[])new String[0], Integer.class)).intValue(); 
        checkCount = ((Integer)getJdbcTemplate().queryForObject(query, (Object[])new String[0], Integer.class)).intValue();
      } catch (Exception e) {
        e.printStackTrace();
      } 
    ...
    try {
      if (beanObj.getStSubCategory().equalsIgnoreCase("ISS")) {
        ...
        if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LORO DEBIT")) {
          query = "SELECT COUNT(*) FROM visa_acq_dom_atm_loro_debit_ttum_data WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LORO CREDIT")) {
          query = "SELECT COUNT(*) FROM visa_acq_dom_atm_loro_credit_ttum_data WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LATE PRESENTMENT")) {
        ...
        if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DROP")) {
          ...
          query = "SELECT COUNT(*) FROM visa_acq_int_atm_loro_debit_ttum_data WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LORO CREDIT")) {
          query = "SELECT COUNT(*) FROM visa_acq_int_atm_loro_credit_ttum_data WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate() + "','%Y/%m/%d')";
        } 
  ...
  public HashMap<String, Object> checkTTUMProcessedVISANB(UnMatchedTTUMBean beanObj) {
    ...
    try {
      ...
      System.out.println("main _  QUERY" + query);
      int checkCount = ((Integer)getJdbcTemplate().queryForObject(query, (Object[])new String[0], Integer.class)).intValue();
      int checkCount2 = ((Integer)getJdbcTemplate().queryForObject(query2, (Object[])new String[0], Integer.class)).intValue();
  ...
  public HashMap<String, Object> checkTTUMProcessedCTC(UnMatchedTTUMBean beanObj) {
    ...
    try {
      if (beanObj.getStSubCategory().equalsIgnoreCase("ACQUIRER")) {
        ...
        query = "SELECT COUNT(*) FROM c2c_iss_recon_ttums WHERE FILEDATE = DATE_FORMAT('" + beanObj.getLocalDate() + "','%Y/%m/%d')AND TTUM_TYPE = '" + beanObj.getTypeOfTTUM() + "'";
      } 
      System.out.println("main _  QUERY" + query);
      int checkCount = ((Integer)getJdbcTemplate().queryForObject(query, (Object[])new String[0], Integer.class)).intValue();
      if (checkCount > 0) {
    ...
    try {
      ...
      if (beanObj.getStSubCategory().equalsIgnoreCase("ACQUIRER_DOM")) {
        ...
        if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DECLINE")) {
          ...
          query = "SELECT count(*) FROM  mastercard_proactive_pos_ttum    WHERE  filedate= str_to_date('" + beanObj.getFileDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DROP")) {
          query = "SELECT count(*) FROM mc_iss_pos_drop_ttum   WHERE filedate= str_to_date('" + beanObj.getFileDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LATE PRESENTMENT")) {
          query = "SELECT count(*) FROM  mc_iss_pos_latepres_ttum  WHERE  filedate= str_to_date('" + beanObj.getFileDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("OFFLINE PRESENTMENT")) {
          query = "SELECT count(*) FROM  dom_offline_pres_ttum  WHERE  filedate= str_to_date('" + beanObj.getFileDate() + "','%Y/%m/%d')";
        } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("SURCHARGED")) {
          query = "SELECT count(*) FROM mc_dom_iss_dr_surch    WHERE filedate= str_to_date('" + beanObj.getFileDate() + "','%Y/%m/%d')";
        } else {
          query = "SELECT count(*) FROM mc_dom_iss_cr_surch    WHERE filedate= str_to_date('" + beanObj.getFileDate() + "','%Y/%m/%d')";
        } 
      } else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DECLINE")) {
  ...
  public HashMap<String, Object> checkReconProcessed(UnMatchedTTUMBean beanObj) {
    ...
    try {
      ...
      int compareCount = ((Integer)getJdbcTemplate().queryForObject(checkCompareCount, 
          new Object[] { beanObj.getFileDate(), beanObj.getCategory(), beanObj.getStSubCategory() }, Integer.class)).intValue();
      if (compareCount >= 3) {
        output.put("result", Boolean.valueOf(true));
  ...
  public boolean checkAndMakeDirectory(UnMatchedTTUMBean beanObj) {
    try {
      ...
      if (checkFile.exists())
        FileUtils.forceDelete(new File(String.valueOf(beanObj.getStPath()) + File.separator + beanObj.getCategory())); 
      File directory = new File(String.valueOf(beanObj.getStPath()) + File.separator + beanObj.getCategory());
      if (!directory.exists())
        directory.mkdir(); 
      directory = new File(
          String.valueOf(beanObj.getStPath()) + File.separator + beanObj.getCategory() + File.separator + "02-01-2024");
      if (!directory.exists())
        directory.mkdir(); 
      beanObj.setStPath(
          String.valueOf(beanObj.getStPath()) + File.separator + beanObj.getCategory() + File.separator + "02-01-2024");
  ...
  public HashMap<String, Object> checkTranReconDate(UnMatchedTTUMBean beanObj) {
    ...
    try {
      ...
      String checckCount = "select COUNT(*) FROM " + tableName + " WHERE FILEDATE >= '" + beanObj.getLocalDate() + 
        "'";
      int getCount = ((Integer)getJdbcTemplate().queryForObject(checckCount, new Object[0], Integer.class)).intValue();
      if (getCount > 0) {
        output.put("result", Boolean.valueOf(true));
      } else {
        output.put("result", Boolean.valueOf(false));
  ...
  public HashMap<String, Object> checkInternationalUpload(UnMatchedTTUMBean beanObj) {
    ...
    try {
      String checkPresentment = "SELECT COUNT(*) FROM rupay_international_presentment WHERE FILEDATE = '" + 
        beanObj.getFileDate() + "'";
      int presentmentCount = ((Integer)getJdbcTemplate().queryForObject(checkPresentment, new Object[0], Integer.class)).intValue();
