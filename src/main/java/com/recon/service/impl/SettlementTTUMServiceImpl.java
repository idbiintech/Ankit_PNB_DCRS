...
public class SettlementTTUMServiceImpl extends JdbcDaoSupport implements SettlementTTUMService {
	...
	public HashMap<String, Object> ANKITTREPORTSnewVISA(NFSSettlementBean beanObj) {
		Map<String, Object> inParams = new HashMap<>();
		HashMap<String, Object> output = new HashMap<>();
		Map<String, Object> outParams2 = new HashMap<>();
		try {
			logger.info("runAdjTTUM EXCEL");
			System.out.println("date " + beanObj.getDatepicker() + " V_ADJTYPE " + beanObj.getAdjType());
			ANKITTREPORTSnewVISA exe = new ANKITTREPORTSnewVISA(getJdbcTemplate());
			inParams.put(" I_FILEDATE", beanObj.getDatepicker());

			inParams.put("V_TTUMTYPE", beanObj.getAdjType());
			outParams2 = exe.execute(inParams);
			String value = outParams2.toString();
			logger.info("NFS_ADJ_REPORT settl " + outParams2.toString() + "value " + value);
			if (value.contains("NOT")) {
	...
	private class ANKITTREPORTSnewVISA extends StoredProcedure {
		private static final String insert_proc = "VISA_ISS_CHB_TTUM";

		public ANKITTREPORTSnewVISA(JdbcTemplate jdbcTemplate) {
			super(jdbcTemplate, insert_proc);
			setFunction(false);
	...
	public List<Object> getDailyNFSTTUMDataMASTERCARD(UnMatchedTTUMBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData = null;
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ISSUER")) {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LATE PRESENTMENT")) {
					getData = "SELECT LPAD(AC_NO,15,'0')||CASE WHEN DR_CR= 'CREDIT' THEN 'C' ELSE 'D' END ||TO_CHAR(TO_DATE(SYSDATE,'DD-MM-RRRR') ,'DDMMYYYY')|| RPAD(NARRATION,50,' ')||LPAD( TO_CHAR(AMOUNT*100,'FM000000000090'),18,'0')  AS TTUM FROM  mc_iss_pos_latepres_ttum WHERfiledate= str_to_date('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')";
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("PROACTIVE")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,CONCAT('INR',516500),'  ',DR_CR\r\n"
							...
							+ ",RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' ')\r\n"
							+ ",LPAD(REMARKS,417,' ')\r\n"
							+ ")  AS TTUM FROM mastercard_proactive_pos_ttum   WHERE filedate= str_to_date('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')";
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DROP")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,CONCAT('INR',516500),'  ',DR_CR\r\n  ,LPAD(REPLACE(FORMAT(CASE WHEN DR_CR='C' THEN AMOUNT ELSE AMOUNT END, 2),',',''),17,'0')\r\n,RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(REMARKS,417,' ')\r\n)  AS TTUM FROM mc_iss_pos_drop_ttum    WHERE filedate= str_to_date('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')";
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
					...
					return DailyData;
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("SURCHARGED H")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,CONCAT('INR',516500),'  ',DR_CR\r\n  ,LPAD(REPLACE(FORMAT(CASE WHEN DR_CR='C' THEN SUR ELSE SUR END, 2),',',''),17,'0')\r\n,RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(REMARKS,417,' ')\r\n)  AS TTUM FROM mc_dom_iss_dr_surch WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d')  and SUBSTR(NARRATION,1,4)='MHTC'";
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
									List<Object> beanList = new ArrayList<Object>();
					...
					return DailyData;
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("SURCHARGED R")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,CONCAT('INR',516500),'  ',DR_CR\r\n  ,LPAD(REPLACE(FORMAT(CASE WHEN DR_CR='C' THEN SUR ELSE SUR END, 2),',',''),17,'0')\r\n,RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(REMARKS,417,' ')\r\n)  AS TTUM FROM mc_dom_iss_dr_surch WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d') and SUBSTR(NARRATION,1,4)='MRLC'";
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
									List<Object> beanList = new ArrayList<Object>();
					...
					return DailyData;
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("SURCHARGED P")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,CONCAT('INR',516500),'  ',DR_CR\r\n  ,LPAD(REPLACE(FORMAT(CASE WHEN DR_CR='C' THEN SUR ELSE SUR END, 2),',',''),17,'0')\r\n,RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(REMARKS,417,' ')\r\n)  AS TTUM FROM mc_dom_iss_dr_surch WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d') and SUBSTR(NARRATION,1,4)='MPET'";
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
									List<Object> beanList = new ArrayList<Object>();
					...
					return DailyData;
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("SURCHARGED O")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,CONCAT('INR',516500),'  ',DR_CR\r\n  ,LPAD(REPLACE(FORMAT(CASE WHEN DR_CR='C' THEN SUR ELSE SUR END, 2),',',''),17,'0')\r\n,RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(REMARKS,417,' ')\r\n)  AS TTUM FROM mc_dom_iss_dr_surch WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d') and SUBSTR(NARRATION,1,4)='MOTH'";
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
									List<Object> beanList = new ArrayList<Object>();
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("OFFLINE PRESENTMENT")) {
					getData = "SELECT LPAD(AC_NO,15,'0') ||CASE WHEN DR_CR='CREDIT' THEN 'C' ELSE 'D' END ||  TO_DATE(FILEDATE,'DD-MM-YY') ||RPAD(SUBSTR(NARRATION,1,LENGTH(NARRATION) ),50,' ') || \r\n    CASE WHEN DR_CR='CREDIT' THEN LPAD( TO_CHAR(AMOUNT*100,'FM000000000090'),18,'0') ELSE LPAD( TO_CHAR(AMOUNT*100,'FM000000000090'),18,'0') END AS TTUM FROM  dom_offline_pres_ttum WHERE  filedate= str_to_date('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')";
					System.out.println(" getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
	...
	public List<Object> getDailyVISATTUMData(NFSSettlementBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData = null;
			if (beanObj.getAdjType().equalsIgnoreCase("CHBK_ACPT")) {
				getData = "SELECT CONCAT(RPAD(AC_NO,16,' '),'INR','51500',' ',DR_CR,LPAD(REPLACE(FORMAT(Amount,2),',',''),17,' '),RPAD(CONCAT('REPR/',SUBSTR(card_no,1,6),SUBSTR(card_no,-4),'/',AUTH_CODE),30,' '),\n"
						+ "LPAD(DATE_FORMAT(FILEDATE,'%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM  FROM visa_chb_ttum WHERE NARRATION='CHBK_ACPT' AND FILEDATE=STR_TO_DATE('"
				...
				getData = "\n"
						+ "SELECT CONCAT(RPAD(AC_NO,16,' '),'INR','51500',' ',DR_CR,LPAD(REPLACE(FORMAT(Amount,2),',',''),17,' '),RPAD(CONCAT('REPR/',SUBSTR(card_no,1,6),SUBSTR(card_no,-4),'/',AUTH_CODE),30,' '),\n"
						+ "LPAD(DATE_FORMAT(FILEDATE,'%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM  FROM visa_chb_ttum WHERE NARRATION='CHBK_REJECT' AND FILEDATE=STR_TO_DATE('"
						+ beanObj.getDatepicker() + "','%Y/%m/%d')";
				System.out.println("Data " + getData);
		...
		try {
			...
			if (beanObj.getAdjType().equalsIgnoreCase("PENALTY")) {
				getData = "select CONCAT(RPAD(AC_NO,16,' ') ,'INR',SUBSTR(AC_NO,1,6),'  ',DR_CR,LPAD(REPLACE(FORMAT(AMOUNT, 2),',',''),17,'0'),\n"
						+ "RPAD(NARRATION,40,' '),REMARKS,LPAD(DATE_FORMAT(str_to_date(TXN_DATE,'%d-%m-%Y'),'%d-%m-%Y'),113,' '),LPAD(CONCAT('ADJ',UID) ,417,' ')) AS TTUM\n"
						+ "from nfs_adj_report where FILEDATE=STR_TO_DATE('" + beanObj.getDatepicker()
	...
	public List<Object> getDailyNFSTTUMDataICD(NFSSettlementBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData = null;
			if (beanObj.getAdjType().equalsIgnoreCase("PENALTY")) {
		...
		try {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ACQUIRER")) {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LORO CREDIT")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(AMOUNT, 2),',',''),17,'0'),\r\n"
							+ "RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,418,' ')) AS TTUM\r\n"
							+ "FROM nfs_iccw_acq_recon_ttums WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate()
							+ "','%Y/%m/%d')  AND TTUM_TYPE='LORO CREDIT'";

				} else {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(AMOUNT, 2),',',''),17,'0'),\r\n"
							+ "RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,418,' ')) AS TTUM\r\n"
							+ "FROM nfs_iccw_acq_recon_ttums WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate()
							+ "','%Y/%m/%d')  AND TTUM_TYPE='LORO DEBIT'";
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("PROACTIVE")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(AMOUNT, 2),',',''),17,'0'),\r\n"
							+ "RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,418,' ')) AS TTUM\r\n"
							+ "FROM nfs_iccw_iss_recon_ttums WHERE FILEDATE=STR_TO_DATE('" + beanObj.getLocalDate()
	...
	public List<Object> getICDTTUM(UnMatchedTTUMBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData = null;
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ISSUER")) {
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("PROACTIVE")) {
					getData = "SELECT LPAD(AC_NO,15,'0')|| DR_CR ||TO_CHAR(TO_DATE(SYSDATE,'DD-MM-RRRR') ,'DDMMYYYY')|| RPAD(NARRATION,50,' ')||LPAD( TO_CHAR(AMOUNT*100,'FM000000000090'),18,'0')  AS TTUM\r\nFROM ICD_ISS_RECON_PROACTIVE  \r\n WHERE TO_DATE(FILEDATE,'DD-MM-YY')=TO_DATE('"
							...
							beanObj.getLocalDate().replaceAll("-", "/") + "','DD-MM-YY')";
					System.out.println("getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
		...
		try {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ISS")) {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("CREDIT SURCHARGE")) {
					...
					return DailyData;
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE FE")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(SUR, 2),',',''),17,'0'),\r\nRPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d') AND SETTLEMENT_FLAG ='0' ";
					System.out.println("getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
					...
					return DailyData;
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE P")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(SUR, 2),',',''),17,'0'),\r\nRPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d') AND MERCHANT_CATEGORY_CODE IN('5541')";
					System.out.println("getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE R")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(SUR, 2),',',''),17,'0'),\r\nRPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d')  AND MERCHANT_CATEGORY_CODE IN('4112')";
					System.out.println("getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE O")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(SUR, 2),',',''),17,'0'),\r\nRPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate()
							+ "','%Y/%m/%d') AND MERCHANT_CATEGORY_CODE IN('4111','4900','9399','5983')";
					System.out.println("getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE H")) {
					getData = "SELECT CONCAT(RPAD(AC_NO,16,' ') ,'INR','516500','  ',DR_CR,LPAD(REPLACE(FORMAT(SUR, 2),',',''),17,'0'),\r\nRPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(UID,413,' ')) AS TTUM\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+

							beanObj.getLocalDate() + "','%Y/%m/%d')  AND MERCHANT_CATEGORY_CODE IN('5812')";
					System.out.println("getData " + getData);
					List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
								public List<Object> extractData(ResultSet rs) throws SQLException {
	...
	public List<Object> getCTCTTUM(UnMatchedTTUMBean beanObj) {
		...
		try {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ACQUIRER")) {
				...
				System.out.println("getData " + getData);
				List<Object> DailyData = getJdbcTemplate().query(getData,
						new Object[] { beanObj.getLocalDate().replaceAll("/", "-"), beanObj.getTypeOfTTUM() },
						new ResultSetExtractor<List<Object>>() {
							public List<Object> extractData(ResultSet rs) throws SQLException {
								List<Object> beanList = new ArrayList<Object>();
	...
	public List<Object> getREEFUNDTTUMTEXTISS(UnMatchedTTUMBean beanObj) {
		...
		try {
			...
			if (beanObj.getCategory().equalsIgnoreCase("MASTERCARD")) {
				...
				getData = "SELECT CONCAT(RPAD(ACCOUNT_NO,17,' ') ,CONCAT('INR',SUBSTR(ACCOUNT_NO,1,6)),' ',DR_CR\r\n  ,LPAD(REPLACE(FORMAT(CASE WHEN DR_CR='C' THEN AMOUNT ELSE AMOUNT END, 2),',',''),17,'0')\r\n,RPAD(NARRATION,30,' '),LPAD(DATE_FORMAT(FILEDATE, '%d-%m-%Y'),113,' '),LPAD(REMARKS,415,' ')\r\n)  AS TTUM FROM rupay_refund_report WHERE FILEDATE=STR_TO_DATE(?,'%Y/%m/%d')  and TTUM_TYPE='"
						+ beanObj.getAcqtypeOfTTUM() + "'  and cate='" + beanObj.getCategory()
						+ "' order by DR_CR      ";
			}
			List<Object> DailyData = getJdbcTemplate().query(getData, new Object[] { beanObj.getFileDate() },
	...
	public boolean TTUMRollbackReportSETTLMASTERCARD(String filedate) {
		...
		Map<String, Object> outParams = new HashMap<>();
		try {
			TTUMRollbackReportSETTLMASTERCARD rollBackexe = new TTUMRollbackReportSETTLMASTERCARD(getJdbcTemplate());
	...
	public boolean rollBackRupayADJ(NFSSettlementBean beanObj) {
		...
		try {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("RUPAY")) {
				...
				} else if (beanObj.getAdjCategory().equalsIgnoreCase("Good Faith Acceptance")) {
					beanObj.setAdjCategory("Rupay_CHBD");
	...
	public boolean rollBackRupayRefund(NFSSettlementBean beanObj) {
		...
		try {
			...
			inParams.put("V_TYPE", beanObj.getStSubCategory());
	...
	public boolean rollBackNFSADJVISA(NFSSettlementBean beanObj) {
		Map<String, Object> inParams = new HashMap<>();
		Map<String, Object> outParams = new HashMap<>();
		try {
			rollBackNFSADJVISA rollBackexe = new rollBackNFSADJVISA(getJdbcTemplate());
			inParams.put("I_FILEDATE", beanObj.getDatepicker());
			inParams.put("V_TTUMTYPE", beanObj.getAdjCategory());
			outParams = rollBackexe.execute(inParams);
			logger.info("OUT PARAM IS" + outParams.get("msg"));
			String data = outParams.get("msg").toString();
			if (data.equalsIgnoreCase("SUCCESS"))
	...
	private class rollBackNFSADJVISA extends StoredProcedure {
		private static final String insert_proc = "VISA_ISS_CHB_TTUM_ROLLBACK";

		public rollBackNFSADJVISA(JdbcTemplate jdbcTemplate) {
			super(jdbcTemplate, insert_proc);
			setFunction(false);
			declareParameter(new SqlParameter("I_FILEDATE", Types.VARCHAR));
			declareParameter(new SqlParameter("V_TTUMTYPE", Types.VARCHAR));
	...
	public List<Object> getAdjTTUMVISA(NFSSettlementBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData1 = null;
			List<Object> DailyData = new ArrayList();

			if (beanObj.getAdjType().equalsIgnoreCase("CHBK_REJECT")) {

				getData1 = "SELECT card_no, AC_NO, AUTH_CODE, ARN, CBK_RSDT, Tran_date, Amount, NARRATION, Reject_date, FILEDATE, TYPE, DR_CR, UID FROM visa_chb_ttum WHERE NARRATION='CHBK_REJECT' AND FILEDATE=STR_TO_DATE('"
						+ beanObj.getDatepicker() + "','%Y/%m/%d')";

			} else {
				getData1 = "SELECT card_no, AC_NO, AUTH_CODE, ARN, CBK_RSDT, Tran_date, Amount, NARRATION, Reject_date, FILEDATE, TYPE, DR_CR, UID FROM visa_chb_ttum WHERE NARRATION='CHBK_ACPT' AND FILEDATE=STR_TO_DATE('"
						+ beanObj.getDatepicker() + "','%Y/%m/%d')";
			...
			DailyData = getJdbcTemplate().query(getData1, new Object[] {}, new ResultSetExtractor<List<Object>>() {
				public List<Object> extractData(ResultSet rs) throws SQLException {
					...
					while (rs.next()) {
						...
						table_Data.put("CBK_RSDT", rs.getString("CBK_RSDT"));
						table_Data.put("Tran_date", rs.getString("Tran_date"));
						table_Data.put("Amount", rs.getString("Amount"));
						table_Data.put("Reject_date", rs.getString("Reject_date"));
						table_Data.put("DR_CR", rs.getString("DR_CR"));
						table_Data.put("TYPE", rs.getString("TYPE"));
	...
	public List<Object> getAdjTTUMICD(NFSSettlementBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData1 = null;
			List<Object> DailyData = new ArrayList();
	...
	public List<Object> getTTUMRUPAY(UnMatchedTTUMBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData1 = null;
			List<Object> DailyData = new ArrayList();
	...
	public List<Object> getTTUMMASTERCARD(UnMatchedTTUMBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData1 = null;
			List<Object> DailyData = new ArrayList();
			if (beanObj.getStSubCategory().contains("ACQUIRER_DOM")) {
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("LORO_CREDIT")) {
					...
					getData1 = "select DR_CR, BANK_NAME, CARD_NO, AC_NO, DATE_OF_TXN, AMOUNT, AUTH_CODE, NARRATION, FILEDATE, REMARKS from mc_acq_cross_recon_ttum where filedate= str_to_date(' "
							+ beanObj.getLocalDate() + "','%Y/%m/%d')";
					logger.info("data get sql " + getData1);
					DailyData = getJdbcTemplate().query(getData1, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
				...
				if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DECLINE")) {
					...
					getData1 = "select DR_CR, DISPUTE_DATE, BANK_NAME, CARD_NO, AC_NO, DATE_OF_TXN, AMOUNT, TRACE_NO, NARRATION from mc_iss_pos_latepres_ttum where filedate= str_to_date('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')";
					logger.info("data get sql " + getData1);
					DailyData = getJdbcTemplate().query(getData1, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
					...
					getData1 = "select DR_CR, DISPUTE_DATE, BANK_NAME, CARD_NO, AC_NO, DATE_OF_TXN, TXN_TIME, TRACE_NO, AMOUNT, NARRATION from   mastercard_proactive_pos_ttum where filedate= str_to_date('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d') ";
					logger.info("data get sql " + getData1);
					DailyData = getJdbcTemplate().query(getData1, new Object[] {},
							new ResultSetExtractor<List<Object>>() {
		...
		try {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ISSUER")) {
				...
				getData1 = "SELECT DR_CR,  DISPUTE_DATE, BANKNAME, CARD_NO, AC_NO, DR_CR, TXN_DATE, TXN_TIME, AMOUNT, RRN, TERMINAL_ID, NARRATION FROM nfs_acq_recon_ttums WHERE  FILEDATE=STR_TO_DATE('"
						+ beanObj.getLocalDate().replaceAll("/", "-") + "','%Y-%m-%d') AND TTUM_TYPE ='"
						+ beanObj.getTypeOfTTUM() + "'  order by CARD_NO , RRN , AMOUNT";
				logger.info("data get sql " + getData1);
				DailyData = getJdbcTemplate().query(getData1, new Object[] {}, new ResultSetExtractor<List<Object>>() {
					public List<Object> extractData(ResultSet rs) throws SQLException {
						List<Object> beanList = new ArrayList<Object>();
	...
	public List<Object> getTTUMVISA(UnMatchedTTUMBean beanObj) {
		...
		try {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("ISS")) {
				...
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE H")) {
					getData1 = "SELECT DR_CR, CARD_NO, TRACE_NO, AC_NO, TRAN_DATE, TRAN_TIME, PURCHASE_DATE, CBS_AMOUNT, VISA_AMOUNT, SUR, NARRATION, AUTH_CODE, SETTLEMENT_FLAG, TC, FILEDATE, UID\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')  AND MERCHANT_CATEGORY_CODE IN('5812') ";
					logger.info("data get sql " + getData1);
					DailyData = getJdbcTemplate().query(getData1, new Object[] {},
				...
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE R")) {
					getData1 = "SELECT DR_CR, CARD_NO, TRACE_NO, AC_NO, TRAN_DATE, TRAN_TIME, PURCHASE_DATE, CBS_AMOUNT, VISA_AMOUNT, SUR, NARRATION, AUTH_CODE, SETTLEMENT_FLAG, TC, FILEDATE, UID\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+ beanObj.getLocalDate() + "','%Y/%m/%d')  AND MERCHANT_CATEGORY_CODE IN('5812') ";
					logger.info("data get sql " + getData1);
					DailyData = getJdbcTemplate().query(getData1, new Object[] {},
				...
				} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("DEBIT SURCHARGE O")) {
					getData1 = "SELECT DR_CR, CARD_NO, TRACE_NO, AC_NO, TRAN_DATE, TRAN_TIME, PURCHASE_DATE, CBS_AMOUNT, VISA_AMOUNT, SUR, NARRATION, AUTH_CODE, SETTLEMENT_FLAG, TC, FILEDATE, UID\r\nFROM visa_iss_dr_surch_ttum_data WHERE FILEDATE=STR_TO_DATE('"
							+ beanObj.getLocalDate()
							+ "','%Y/%m/%d')  AND MERCHANT_CATEGORY_CODE IN('4111','4900','9399','5983')";
					logger.info("data get sql " + getData1);
	...
	public List<Object> getEODGLEXCELDATA(UnMatchedTTUMBean beanObj) {
		List<Object> data = new ArrayList();
		try {
			String getData1 = null;
			List<Object> DailyData = new ArrayList();

			if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_REFUND_GL")) {
				...
				DailyData = getJdbcTemplate().query(getData1, new Object[] {}, new ResultSetExtractor<List<Object>>() {
					public List<Object> extractData(ResultSet rs) throws SQLException {
						...
						while (rs.next()) {
							...
							Map<String, String> table_Data = new HashMap<String, String>();
							table_Data.put("REMARKS", rs.getString("REMARKS"));
							table_Data.put("BALANCE", rs.getString("BALANCE"));
							table_Data.put("DEBIT_Count", rs.getString("DEBIT_Count"));
							table_Data.put("Debit_Amount", rs.getString("Debit_Amount"));
							table_Data.put("CREDIT_Count", rs.getString("CREDIT_Count"));
							table_Data.put("CREDIT_AMOUNT", rs.getString("CREDIT_AMOUNT"));
			...
			} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_ACQ_CHARGEBACK_DOM_GL")) {
			...
			}  else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_REME_CHARGEBACK_DOM_GL")) {
			...
			}  else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_ISS_POOL_GL")) {
			...
			}  else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_INT_BENE_CHARGEBACK_GL")) {
			...
			}  else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_ACQ_INT_POOL_GL")) {
			...
			} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("VISA_ACQ_DOM_POOL_GL")) {
			...
			} else if (beanObj.getTypeOfTTUM().equalsIgnoreCase("NFS_ISS_GL")) {
			...
			if (beanObj.getStSubCategory().equalsIgnoreCase("DOMESTIC")) {
				if (beanObj.getAcqtypeOfTTUM().equalsIgnoreCase("REFUND")) {
					...
					getData1 = "SELECT ACCOUNT_NO,TRANSACTION_DATE, RRN, DR_CR, AMOUNT,NARRATION from  rupay_adjustment_ttum where filedate =str_to_date('"
							+ beanObj.getFileDate() + "','%Y/%m/%d') and TTUM_TYPE='" + beanObj.getAcqtypeOfTTUM()
							+ "' and cate='" + beanObj.getCategory() + "' ";
				}
			} else if (beanObj.getCategory().equalsIgnoreCase("RUPAY_INT_MFC")) {
				if (beanObj.getAcqtypeOfTTUM().equalsIgnoreCase("REFUND")) {
					getData1 = "SELECT  DISPUTE_DATE, BANK_NAME, CARD_NO, ACCOUNT_NO, TRANSECTION_DATE,DR_CR, AMOUNT, RRN, NARRATION FROM  rupay_refund_report WHERE filedate= str_to_date('"
	...
	public List<Object> ExtractRUPAYRawdata(UnMatchedTTUMBean beanObj) {
		...
		try {
			...
			if (beanObj.getCategory().contains("RUPAY_INT")) {
				...
				getData1 = "SELECT  * from rupay_rupay_rawdata WHERE  filedate = STR_to_date('" + beanObj.getLocalDate()
						+ "','%Y/%m/%d')";
