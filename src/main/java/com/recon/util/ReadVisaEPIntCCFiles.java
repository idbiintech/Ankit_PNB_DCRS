...
public class ReadVisaEPIntCCFiles {
	...
	public void fileupload(VisaUploadBean beanObj,MultipartFile file,Connection conn) throws SQLException {
		...
		try
		{
			...
			String Insertvss120 = "INSERT INTO VISA_INT_EP_RAWDATA(MSGTYPE,SUBCATEGORY, CREATEDBY, ISS_ACQ, FILEDATE, DESCRIPTION, SUB_DESCRIPTION, TXN_COUNT, CLEARING_AMT, CLEARING_AMT_SIGN, INT_VAL_CR, INT_VAL_DR, RECORD_COUNT) "+
						"VALUES(?, ?, ?, ?, TO_DATE(?,'DD/MM/YYYY'), ?, ?, ?, ?, ?, ?, ?, ?)";
			
			String InsertVSS110 = "INSERT INTO VISA_INT_EP_RAWDATA(MSGTYPE,SUBCATEGORY, CREATEDBY, ISS_ACQ, FILEDATE,DESCRIPTION, SUB_DESCRIPTION, TXN_COUNT, CREDIT_AMT, DEBIT_AMT, TOTAL_AMT, TOTAL_AMT_SIGN) "+
						"VALUES(?,?,?,?,TO_DATE(?,'DD/MM/YYYY'),?,?,?,?,?,?,?)";
			
			String InsertVSS130 = "INSERT INTO VISA_INT_EP_RAWDATA(MSGTYPE, SUBCATEGORY, CREATEDBY, ISS_ACQ, FILEDATE, DESCRIPTION, SUB_DESCRIPTION, TXN_COUNT, INT_AMT, INT_AMT_SIGN, REIMB_AMT_CR, REIMB_AMT_DR) "+
						"VALUES(?,?,?,?,TO_DATE(?,'DD/MM/YYYY'),?,?,?,?,?,?,?)";
			
			String InsertVSS140 = "INSERT INTO VISA_INT_EP_RAWDATA(MSGTYPE, SUBCATEGORY, CREATEDBY, ISS_ACQ, FILEDATE, DESCRIPTION, SUB_DESCRIPTION, TXN_COUNT, INT_AMT, INT_AMT_SIGN, VISA_CHARGES_DR, VISA_CHARGES_CR) "+
						"VALUES(?,?,?,?,TO_DATE(?,'DD/MM/YYYY'),?,?,?,?,?,?,?)";
			
			String InsertVSS210 = "INSERT INTO VISA_INT_EP_RAWDATA(MSGTYPE, SUBCATEGORY, CREATEDBY, ISS_ACQ, FILEDATE, DESCRIPTION, SETT_CURR_INT_AMNT, SETT_CURR_INT_AMNT_SIGN, SETT_CURR_CONV_FEE, CLR_CURR_INT_AMNT, CLR_CURR_INT_AMNT_SIGN, CLR_CURR_CONV_FEE, CLR_CURR_OPT_ISS_FEE, CLR_CURR_OPT_ISS_FEE_SIGN) "+
						"VALUES(?,?,?,?,TO_DATE(?,'DD/MM/YYYY'), ?, ?, ?, ?, ?, ?, ?, ?, ?)";
