...
public class ReadRupayFile {
	String insert ="INSERT  INTO RUPAY_DOMESTIC_DATA (MTI,Function_Code ,Record_Number,Member_Institution_ID_Code,Unique_File_Name,Date_Settlement,Product_Code,Settlement_BIN,File_Category,Version_Number,"
	...
	String update="update RUPAY_DOMESTIC_DATA  set Trl_FUNCTION_CODE = ? , TRL_RECORD_NUMBER= ?,TRANSACTIONS_COUNT=? where to_char(createdDate,'dd-mm-yy')=to_char(sysdate,'dd-mm-yy')";
	...
	public static void main(String[] args) {
		...
		ReadRupayFile file = new ReadRupayFile();
		file.readData(oracon.getconn());
		}catch (Exception ex ){
