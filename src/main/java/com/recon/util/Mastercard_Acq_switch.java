...
public class Mastercard_Acq_switch extends AbstractExcelView{

	private static final Logger logger = Logger.getLogger(Mastercard_Acq_switch.class); 
	@Override
...
SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyhhmm");
		...
		String strDate = sdf.format(date);
		 ...
		 response.setContentType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
			...
			response.setHeader("Content-disposition", "attachment; filename="+generatettum_list.get(0).get(0).getStCategory()+"_"+generatettum_list.get(0).get(0).getM_surch3()+strDate+".xlsx");
