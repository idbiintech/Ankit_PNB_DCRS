...
public class Mastercard_Iss_Switch extends AbstractExcelView{

	private static final Logger logger = Logger.getLogger(Mastercard_Iss_Switch.class); 
	@Override
...
SimpleDateFormat sdf = new SimpleDateFormat("ddMMyyhhmm");
		...
		String strDate = sdf.format(date);
		 ...
		 response.setContentType("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
			...
			response.setHeader("Content-disposition", "attachment; filename="+"CYCLE-1_SWITCH"+strDate+".xlsx");
