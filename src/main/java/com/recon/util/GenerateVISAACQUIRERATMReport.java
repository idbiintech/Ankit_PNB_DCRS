...
public class GenerateVISAACQUIRERATMReport extends AbstractExcelView {
  protected void buildExcelDocument(Map<String, Object> map, HSSFWorkbook workbook1, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    createSheet(workbook, "VISA-ACQ-DOM-ATM-UNRECON-1-SWITCH", Data, 2, 3, maxRowCount);
    createSheet(workbook, "VISA-ACQ-DOM-ATM-MATCHED-1-CBS", Data, 4, 5, maxRowCount);
    createSheet(workbook, "VISA-ACQ-DOM-ATM-UNRECON-1-CBS", Data, 6, 7, maxRowCount);
    createSheet(workbook, "ACQ-CBS-KNOCKOFF", Data, 8, 9, maxRowCount);
    createSheet(workbook, "VISA-ACQ-DOM-ATM-MATCHED-2-CBS", Data, 10, 11, maxRowCount);
    createSheet(workbook, "VISA-ACQ-DOM-ATM-UNRECON-2-CBS", Data, 12, 13, maxRowCount);
    createSheet(workbook, "VISA-ACQ-DOM-ATM-MATCHED-2-VISA", Data, 14, 15, 
        maxRowCount);
    createSheet(workbook, "VISA-ACQ-DOM-ATM-UNRECON-2-VISA", Data, 16, 17, maxRowCount);
