    ...
    try {
      ...
      while ((line = br.readLine()) != null) {
        if (!line.trim().equalsIgnoreCase("")) {
          ...
          if ((DESPUT_TYPE.contains("ACQUIRER TRANSACTION") && line.trim().startsWith("255")) || line.trim().startsWith("47")  || line.trim().startsWith("12") || line.trim().startsWith("07") || line.trim().startsWith("10") || line.trim().startsWith("02") || line.trim().startsWith("21") || line.trim().startsWith("16") || line.trim().startsWith("15") || line.trim().startsWith("14") || line.trim().startsWith("13")) {
            Code = line.trim().substring(0, 3);
        
            if (line.trim().length() != 117 && 
              line.trim().length() != 92)
              if (line.trim().length() != 86) {
                if (line.trim().startsWith("21") || line.trim().startsWith("47") || line.trim().startsWith("15") || line.trim().startsWith("16") || line.trim().startsWith("14") || line.trim().startsWith("12") || line.trim().startsWith("02") || line.trim().startsWith("10") || line.trim().startsWith("07") || line.trim().startsWith("10") || line.trim().startsWith("07") || line.trim().startsWith("13")) {
