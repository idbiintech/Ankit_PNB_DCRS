...
public class GenerateUCOTTUM extends JdbcDaoSupport {
  ...
  public void generateMastercardEODTTUM(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName) {
    ...
    try {
      for (int j = 1; j <= 1; j++) {
        ...
        file.createNewFile();
        BufferedWriter out = new BufferedWriter(new FileWriter(String.valueOf(stPath) + File.separator + newFileName, true));
        int startLine = 0;
  ...
  public void generateMastercardTTUMFiles(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName) {
    List<String> files = new ArrayList<>();
    System.out.println("inside the next ");
    try {
      for (int j = 1; j <= 1; j++) {
        ...
        if (lstData.size() > 0) {
          for (int i = 0; i < lstData.size(); i++) {
            ...
            if (TTUMName.equalsIgnoreCase("DECLINED")) {
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACC_NO") + "~" + 
                  (String)table_Data.get("DRCR"));
              lineData.append("~" + (String)table_Data.get("AMOUNT") + "~" + (String)table_Data.get("perticulers"));
            } 
            if (TTUMName.equalsIgnoreCase("REFUND")) {
              lineData.append(String.valueOf(table_Data.get("ACCTYPE")) + "~" + (String)table_Data.get("ACCOUNTNO") + "~" + 
                  (String)table_Data.get("DRCR"));
              lineData.append("~" + (String)table_Data.get("REFUND") + "~" + (String)table_Data.get("perticulers"));
            } 
  ...
  public void generateMastercardTTUMFiles_20112023(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName) {
    List<String> files = new ArrayList<>();
    System.out.println("inside the next ");
    try {
      for (int j = 1; j <= 1; j++) {
  ...
  public void generateMastercardReportFiles(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName) {
    List<String> files = new ArrayList<>();
    System.out.println("inside the next ");
    try {
      for (int j = 1; j <= 1; j++) {
        ...
        for (int i = 0; i < lstData.size(); i++) {
          ...
          if (TTUMName.equalsIgnoreCase("1")) {
            lineData.append(String.valueOf(table_Data.get("PAN")) + "|" + (String)table_Data.get("PROCESSING_CODE") + "|" + 
                (String)table_Data.get("AMOUNT"));
            lineData.append("|" + (String)table_Data.get("AMOUNT_RECON") + "|" + (String)table_Data.get("CONV_RATE_RECON"));
            lineData.append("|" + (String)table_Data.get("DATE_VAL") + "|" + (String)table_Data.get("EXPIRE_DATE"));
            lineData.append("|" + (String)table_Data.get("DATA_CODE") + "|" + (String)table_Data.get("CARD_SEQ_NUM"));
            lineData.append("|" + (String)table_Data.get("FUNCATION_CODE") + "|" + (String)table_Data.get("MSG_RES_CODE"));
            lineData.append("|" + (String)table_Data.get("CARD_ACC_CODE") + "|" + (String)table_Data.get("AMOUNT_ORG"));
            lineData.append("|" + (String)table_Data.get("AQUIERER_REF_NO") + "|" + (String)table_Data.get("FI_ID_CODE"));
            lineData.append("|" + (String)table_Data.get("RETRV_REF_NO") + "|" + (String)table_Data.get("APPROVAL_CODE"));
            lineData.append(
                "|" + (String)table_Data.get("SERVICE_CODE") + "|" + (String)table_Data.get("CARD_ACC_TERM_ID"));
            lineData.append(
                "|" + (String)table_Data.get("CARD_ACC_ID_CODE") + "|" + (String)table_Data.get("ADDITIONAL_DATA"));
            lineData.append("|" + (String)table_Data.get("CURRENCY_CODE_TRAN") + "|" + 
                (String)table_Data.get("CURRENCY_CODE_RECON"));
            lineData.append(
                "|" + (String)table_Data.get("TRAN_LIFECYCLE_ID") + "|" + (String)table_Data.get("TRAN_DEST_ID_CODE"));
            lineData.append(
                "|" + (String)table_Data.get("TRAN_ORG_ID_CODE") + "|" + (String)table_Data.get("CURRENCY_CODE_TRAN"));
            lineData.append(
                "|" + (String)table_Data.get("CARD_ISS_REF_DATA") + "|" + (String)table_Data.get("RECV_INST_IDCODE"));
            lineData.append("|" + (String)table_Data.get("TERMINAL_TYPE") + "|" + (String)table_Data.get("ELEC_COM_INDIC"));
            lineData.append(
                "|" + (String)table_Data.get("PROCESSING_MODE") + "|" + (String)table_Data.get("CURRENCY_EXPONENT"));
            lineData.append("|" + (String)table_Data.get("BUSINESS_ACT") + "|" + (String)table_Data.get("SETTLEMENT_IND"));
            lineData.append(
                "|" + (String)table_Data.get("CARD_ACCP_NAME_LOC") + "|" + (String)table_Data.get("HEADER_TYPE"));
            lineData.append("|" + (String)table_Data.get("HEADER_TYPE") + "|" + (String)table_Data.get("FILE_NAME"));
            lineData.append("|" + (String)table_Data.get("FILEDATE") + "|" + (String)table_Data.get("FPAN"));
          } 
          out.write(lineData.toString());
        } 
        out.flush();
  ...
  public void generateTTUMFile(String stPath, String FileName, List<Object> TTUMData) {
    try {
      ...
      if (file.exists())
        FileUtils.forceDelete(file); 
      file.createNewFile();
      BufferedWriter out = new BufferedWriter(new FileWriter(String.valueOf(stPath) + File.separator + FileName, true));
      int startLine = 0;
      for (int i = 0; i < TTUMData.size(); i++) {
        ...
        if (FileName.contains("VISA")) {
          lineData.append(String.valueOf(table_Data.get("SR_NO")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
              (String)table_Data.get("PART_TRAN_TYPE") + "~");
          lineData.append(
              String.valueOf(table_Data.get("TRANSACTION_AMOUNT")) + "~" + (String)table_Data.get("TRANSACTION_PARTICULAR"));
        } else {
          lineData.append(String.valueOf(table_Data.get("SR_NO")) + "~" + ((String)table_Data.get("ACCOUNT_NUMBER")).trim() + "~" + (
      ...
      for (int j = 1; j <= fileCount; j++) {
        ...
        for (int i = 0; i < lstData.size(); i++) {
          ...
          lineData.append(String.valueOf(table_Data.get("ACCOUNT_NUMBER")) + "  " + "INR1735" + "    " + 
              (String)table_Data.get("PART_TRAN_TYPE"));
          lineData.append(String.valueOf(table_Data.get("TRANSACTION_AMOUNT")) + (String)table_Data.get("TRANSACTION_PARTICULAR"));
          lineData.append(
              "                                                                                                       ");
  ...
  public void generateCsvSurcharge(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName) {
    try {
      for (int j = 1; j <= fileCount; j++) {
        List<Object> lstData = (ArrayList)TTUMData.get(j - 1);
        String newFileName = FileName.replaceAll(".txt", "_" + j + ".txt");
        ...
        for (int i = 0; i < lstData.size(); i++) {
          ...
          startLine++;
          StringBuffer lineData = new StringBuffer();
          lineData.append(String.valueOf(table_Data.get("PREDEFINED")) + "," + (String)table_Data.get("PREDEFINED_1") + "," + 
              (String)table_Data.get("PREDEFINED_2") + "," + (String)table_Data.get("SERVICE_OUTLET") + "," + 
              (String)table_Data.get("PART_TRAN_TYPE") + "," + (String)table_Data.get("ACCOUNT_NUMBER") + "," + 
          ...
          lineData.append(
              String.valueOf(table_Data.get("TRANSACTION_PARTICULAR")) + "," + (String)table_Data.get("TRANSACTION_AMOUNT"));
          out.write(lineData.toString());
        } 
        out.flush();
        out.close();
  ...
  public void generateADJTTUMFilesRUPAYRUFUND(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName, UnMatchedTTUMBean beanObj) {
    try {
      File file = new File(String.valueOf(stPath) + File.separator + FileName);
      if (file.exists())
        FileUtils.forceDelete(file); 
  ...
  public void generateADJTTUMFilesMASTERCARDRUFUND(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName, MastercardUploadBean beanObj) {
    try {
      File file = new File(String.valueOf(stPath) + File.separator + FileName);
      if (file.exists())
        FileUtils.forceDelete(file); 
  ...
  public void generateADJTTUMFiles(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName, NFSSettlementBean beanObj) {
    try {
      File file = new File(String.valueOf(stPath) + File.separator + FileName);
      if (file.exists())
        FileUtils.forceDelete(file); 
  ...
  public void generateNFSRECONACQTTUM(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName, UnMatchedTTUMBean beanObj) {
    try {
      File file = new File(String.valueOf(stPath) + File.separator + FileName);
      if (file.exists())
        FileUtils.forceDelete(file); 
  ...
  public void generateADJTTUMFilesRupay(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName, RupayUploadBean beanObj) {
    try {
      File file = new File(String.valueOf(stPath) + File.separator + FileName);
      if (file.exists())
        FileUtils.forceDelete(file); 
  ...
  public void generateREFUNDTTUM(String stPath, String FileName, int fileCount, List<Object> TTUMData, String TTUMName, UnMatchedTTUMBean beanObj) {
    try {
      File file = new File(String.valueOf(stPath) + File.separator + FileName);
      if (file.exists())
        FileUtils.forceDelete(file); 
        ...
        for (int i = 0; i < lstData.size(); i++) {
          ...
          if (TTUMName.equalsIgnoreCase("RUPAY")) {
            if (((String)table_Data.get("TRANSACTION_PARTICULAR")).contains("RPY")) {
              lineData.append(String.valueOf(table_Data.get("SERVICE_OUTLET")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + 
                  "~" + (String)table_Data.get("PART_TRAN_TYPE"));
              ...
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
                  (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append("~" + (String)table_Data.get("TRANSACTION_AMOUNT") + "~" + (
                  
                  (table_Data.get("TRANSACTION_PARTICULAR") == null) ? "" : 
                  table_Data.get("TRANSACTION_PARTICULAR")) + 
                  "_" + (String)table_Data.get("FILEDATE"));
            } else if (((String)table_Data.get("TRANSACTION_PARTICULAR")).equalsIgnoreCase("RUP ECOM CHBK ACPT")) {
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
                  (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append("~" + (String)table_Data.get("TRANSACTION_AMOUNT") + "~" + (
              ...
              (String)table_Data.get("TRANSACTION_PARTICULAR")).equalsIgnoreCase("RUP ECOM VOID REFUND")) {
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
                  (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append("~" + (String)table_Data.get("TRANSACTION_AMOUNT") + "~" + 
                  (String)table_Data.get("TRANSACTION_PARTICULAR") + 
              ...
              (String)table_Data.get("TRANSACTION_PARTICULAR")).equalsIgnoreCase("RUP ECOM PRE ARB ACP") || (
              (String)table_Data.get("TRANSACTION_PARTICULAR"))
              .equalsIgnoreCase("RUP ECOM VOID REFUND CR")) {
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
                  (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append(
                  "~" + (String)table_Data.get("TRANSACTION_AMOUNT") + " " + (String)table_Data.get("DISP_DATE") + " " + (
                  (table_Data.get("TRANSACTION_PARTICULAR") == null) ? "" : 
                  table_Data.get("TRANSACTION_PARTICULAR")) + 
                  " " + (String)table_Data.get("REMARKS") + "-" + (String)table_Data.get("FILEDATE"));
            } else if (((String)table_Data.get("TRANSACTION_PARTICULAR")).equalsIgnoreCase("RUP ECOM CHB ACPT") || (
              (String)table_Data.get("TRANSACTION_PARTICULAR")).equalsIgnoreCase("RUP ECOM PRE ARB ACPT")) {
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
                  (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append(
                  "~" + (String)table_Data.get("TRANSACTION_AMOUNT") + "~" + (String)table_Data.get("DISP_DATE") + " " + (
                  ...
                  (String)table_Data.get("TXN_SETTLEMENT_DATE") + "~" + (String)table_Data.get("UNQ_ID"));
            } else {
              lineData.append(String.valueOf(table_Data.get("ACC_TYPE")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + "~" + 
                  (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append("~" + (String)table_Data.get("TRANSACTION_AMOUNT") + "~" + (
            ...
            if (FileName.contains("NFS-EOD")) {
              lineData.append(String.valueOf(table_Data.get("ACCCOUNT_TYPE_1")) + "~" + (String)table_Data.get("ACCOUNT_NUMBER") + 
                  "~" + (String)table_Data.get("PART_TRAN_TYPE"));
              lineData.append("~" + (String)table_Data.get("TRANSACTION_AMOUNT") + "~" + (
                  (table_Data.get("TRANSACTION_PARTICULAR") == null) ? "" : 
                  table_Data.get("TRANSACTION_PARTICULAR")) + 
                  "_" + (String)table_Data.get("ADJTYPE") + "_C" + (String)table_Data.get("REMARKS"));
              System.out.println("FILEDATE CHECKING" + (String)table_Data.get("TRANSACTION_PARTICULAR"));
            } else {
              lineData.append(String.valueOf(table_Data.get("DR/CR")) + "~" + (String)table_Data.get("ACQ_BANK") + "~" + 
                  (String)table_Data.get("TXNDATE"));
              lineData.append("~" + (String)table_Data.get("RRN") + "~" + (
                  (table_Data.get("CARD_NO") == null) ? "" : table_Data.get("CARD_NO")));
              lineData.append(String.valueOf(table_Data.get("ADJAMOUNT")) + "~" + (String)table_Data.get("ACCOUNTNO") + "~" + 
  ...
  public void generateExcelTTUMReport(String stPath, String FileName, List<Object> ExcelData, String TTUMName, String zipName) {
    ...
    try {
      ...
      logger.info("Before zipping all files zipname is " + zipName);
      FileOutputStream fos = new FileOutputStream(String.valueOf(stPath) + File.separator + zipName + File.separator);
      ZipOutputStream zipOut = new ZipOutputStream(new BufferedOutputStream(fos));
      try {
        for (String filespath : files) {
          File input = new File(filespath);
